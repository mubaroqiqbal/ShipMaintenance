...
class GuidelineBook extends StatefulWidget {
  static bool isLoading;

  @override
  _GuidelineBook createState() => _GuidelineBook();

}

class _GuidelineBook extends State<GuidelineBook>{
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("6:30", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.transparent),),
                              Row(
